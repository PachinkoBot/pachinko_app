	...
	data: function() {
		return {
			team_members: [
				...
				{name: "Stephanie Djajadi", id: "stephanie", image:"static/images/temp-prof.jpg", position: "Finance Minister",
				description: "I'm a first-year studying computer science and data science, and I'm excited to learn about the potential of humanitarian applications of robotics. Outside of school, I like eating ramen, learning random fun facts, and exploring new places!",
				social: [{text: "github", href: "https://github.com/gurkirand", id:"github"}, {text: "email", href: "mailto:gurkirand@gmail.com", id: "email"}]},
				...
				social: [{text: "github", href: "https://github.com/gurkirand", id:"github"}, {text: "email", href: "mailto:gurkirand@gmail.com", id: "email"}]},
				{name: "William Tai", id: "will", image:"static/images/temp-prof.jpg", position: "Team Leader",
